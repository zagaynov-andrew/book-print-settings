...
class TestPrintPages(unittest.TestCase):
    ...
    def test_negative(self):
        res = book_print_settings(-2)
        self.assertEqual(res, 'Error')
        return

    def test_0(self):
        res = book_print_settings(0)
        self.assertEqual(res, [])
        return

    def test_1(self):
        res = book_print_settings(1)
    ...
    def test_3(self):
        res = book_print_settings(3)
        self.assertEqual(res, [(0, 1), '@', (2, 3)])
        return

    def test_4(self):
        res = book_print_settings(4)
        self.assertEqual(res, [(4, 1), '@', (2, 3)])
        return

    def test_5(self):
        res = book_print_settings(5)
        self.assertEqual(res, [(0, 1), (0, 3), '@', (2, 0), (4, 5)])
        return

    def test_6(self):
        res = book_print_settings(6)
